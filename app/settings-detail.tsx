          ...
          {section === "notifications" && (
            <View style={{ gap: 12 }}>
              <SettingToggle
                ...
                onValueChange={(v) =>
                  setNotificationsState((s) => ({ ...s, medication: v }))
                }
              />
              <SettingToggle
                ...
                onValueChange={(v) =>
                  setNotificationsState((s) => ({ ...s, meals: v }))
                }
              />
              <SettingToggle
                ...
                onValueChange={(v) =>
                  setNotificationsState((s) => ({ ...s, plans: v }))
                }
              />
              <SettingToggle
                ...
                onValueChange={(v) =>
                  setNotificationsState((s) => ({ ...s, emergency: v }))
                }
              />
            </View>
          )}
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    ...
                    <Text
                      style={[
                        styles.langSelected,
                        selectedLanguage === item.code && { color: "#10B981" },
                      ]}
                    >
            ...
            <View style={{ gap: 12 }}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Alert.alert(
                    "Download",
                    "A data export request has been initiated.",
                  )
                }
              >
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  Alert.alert(
                    "Delete account",
                    "To delete your account, contact support or follow the deletion flow.",
                  )
                }
              >
  ...
  switch (section) {
    case "notifications":
      return {
        ...
        iconBg: "#FEF3C7",
        description:
          "Manage reminders and activity alerts so you only receive what matters.",
        items: [
    ...
    case "language-region":
      return {
        ...
        iconBg: "#DBEAFE",
        description:
          "Choose your preferred language, date format, and regional display options.",
        items: [
          "App language",
    ...
    case "privacy-security":
      return {
        ...
        iconBg: "#FCE7F3",
        description:
          "Control account safety and how your medical information is protected.",
        items: [
    ...
    case "data-privacy":
      return {
        ...
        iconBg: "#F3E8FF",
        description:
          "Manage data export, backups, sharing preferences, and account deletion requests.",
        items: [
          "Download my data",
          "Automatic backups",
    ...
    case "help-support":
      return {
        ...
        iconBg: "#D1FAE5",
        description:
          "Find answers and contact support for account or health app guidance.",
        items: [
          "FAQ and tutorials",
          "Contact support",
          "Report a problem",
    ...
    default:
      return {
        ...
        iconBg: "#E5E7EB",
        description:
          "Open a settings category from the profile page to view details.",
        items: [
          "Notifications",
          "Language & Region",
          "Privacy & Security",
