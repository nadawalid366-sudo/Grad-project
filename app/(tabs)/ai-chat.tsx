...
export default function AIChatScreen() {
  ...
  return (
    <SafeAreaView edges={['top', 'left', 'right']} style={[styles.container, { backgroundColor: bg }]}>
      {/* Header */}
      ...
      >
        ...
        {/* Input bar */}
        <View style={[styles.inputBar, { backgroundColor: surface, borderTopColor: isDark ? COLORS.borderDark : COLORS.border, paddingBottom: insets.bottom > 0 ? insets.bottom : 10 }]}>
          <TextInput
